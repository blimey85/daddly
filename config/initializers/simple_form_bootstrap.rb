...
#     b.use :full_error, wrap_with: { tag: 'div', class: 'invalid-feedback d-block col' }
#     b.use :hint, wrap_with: { tag: 'small', class: 'form-text text-muted' }
#   end
#
...
#         bb.use :input, class: 'form-check-input', error_class: 'is-invalid', valid_class: 'is-valid'
#         bb.use :label, class: 'form-check-label'
#         bb.use :full_error, wrap_with: { tag: 'div', class: 'invalid-feedback d-block col' }
#         bb.use :hint, wrap_with: { tag: 'small', class: 'form-text text-muted' }
#       end
#     end
#   end
...
#
#   # # vertical input for radio buttons and check boxes
#   # config.wrappers :vertical_collection, item_wrapper_class: 'form-check', tag: 'fieldset', class: 'form-group3', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
#   #   b.use :html5
#   #   b.optional :readonly
#   #   b.wrapper :legend_tag, tag: 'legend', class: 'col-form-label pt-0' do |ba|
#   #     ba.use :label_text
...
#
  ...
  #     ba.use :full_error, wrap_with: { tag: 'div', class: 'invalid-feedback d-block col' }
  #     ba.use :hint, wrap_with: { tag: 'small', class: 'form-text text-muted' }
  #   end
  # end
#
...
SimpleForm.setup do |config|
  ...
  config.wrappers :horizontal_collection, item_wrapper_class: 'col', tag: 'fieldset', class: 'form-group', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    ...
    b.wrapper :grid_wrapper, tag: 'div', class: 'row justify-content-md-center' do |ba|
      ...
      ba.use :full_error, wrap_with: { tag: 'div', class: 'invalid-feedback d-block col' }
      # ba.use :hint, wrap_with: { tag: 'small', class: 'form-text text-muted' }
      ba.use :hint, wrap_with: { tag: 'div', class: 'checkbox-errors' }
    end
  end
